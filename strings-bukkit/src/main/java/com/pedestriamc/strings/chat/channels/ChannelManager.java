...
public class ChannelManager {
    ...
    public Channel getWorldChannel(World world) {
        return worldChannels.get(world);
    }
    ...
    @Deprecated
    @Nullable
    public Channel getWorldChannel(String world) {
        return getWorldChannel(Bukkit.getWorld(world));
    }
    ...
    public ArrayList<Channel> getNonProtectedChannels() {
        return getChannelList().stream()
                .filter(c -> c.getType() != Type.PROTECTED)
